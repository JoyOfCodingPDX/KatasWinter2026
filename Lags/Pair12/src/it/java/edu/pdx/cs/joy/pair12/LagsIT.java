...
//    InvokeMainTestCase.MainMethodResult result = invokeMain(Lags.class, "edu/pdx/cs/joy/pair12/flightInfo.txt");
...
//  }
  ...
  {
    InputStream flight = Lags.class.getResourceAsStream("flightInfo.txt");
